 ...
 * 4 结单
 */
module.exports = class OrderOfferHelpModel extends Model {

    async add({ order_id,title, content, gender_constraint, college, max_number }, reqUser) {
        ...
        let { affectedRows: affectedRow2 } = await this.query(sqls.orderRun.addMultiRunOrder, {
            order_id, content, gender_constraint, max_number,title
        });
